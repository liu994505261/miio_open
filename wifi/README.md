...
将MIIO模组作为透传通道，通过串口和主控芯片进行业务逻辑交互。
...
**注意：申请产品前需创建企业开发组，企业开发组管理员及以上拥有创建新产品权限。**
...
**开始之前确保你已经阅读了[开放平台>开发引导](https://open.home.mi.com/guide.html#/id=28/) 中关于产品功能定义的相关介绍。**

### 产品Profile设计

产品Profile，即为对产品功能抽象化，将**属性、方法、事件**三部分功能以接口实现方式进行描述。  

**请阅读示例 [空气净化器举例](../md_images/设备profile模板-空气净化器举例.pdf)，你可以参考示例文档对你的产品功能进行梳理**
...
![open321](../md_images/new/open321.png)  
